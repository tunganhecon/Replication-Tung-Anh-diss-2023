...
*computing transitions for those with earning lower than median
preserve 
...
export excel using Imp_2Dummies`name'l50.xlsx, firstrow(var) replace
...
export excel using Imp_2Dummies`name'h50.xlsx, firstrow(var) replace